 ...
 */
final class Version20200528174432 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE role (id INT AUTO_INCREMENT NOT NULL, id_faction INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(510) NOT NULL, is_unique TINYINT(1) NOT NULL, active_at_night TINYINT(1) NOT NULL, image_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE account ADD is_admin TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE account DROP is_admin');
    }
}
